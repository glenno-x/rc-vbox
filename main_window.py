...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 494, 409))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.scrollAreaWidgetContents)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.listView_settings = QtWidgets.QListView(self.scrollAreaWidgetContents)
        font = QtGui.QFont()
        font.setFamily("Arundina Sans Mono")
        self.listView_settings.setFont(font)
        self.listView_settings.setObjectName("listView_settings")
        self.horizontalLayout_3.addWidget(self.listView_settings)
